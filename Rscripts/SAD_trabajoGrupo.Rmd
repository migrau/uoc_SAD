...
####*SEXO:* 
Esta variable nos informa del sexo del paciente. Es una variable de tipo cualitativo nominal, y puede ser tomar dos valore diferentes :hombre o mujer.
...
De entrada, un mayor nivel de CD4 podría indicar un menor nivel de carga viral (CV), ya que no existen muestras en el cuadrante superior derecha a partir de 500 cel/ml de CD4. Con una muestra tan limitada es dificil extraer una información pero podriamos decir que a niveles bajo-medios de CD4 (menor de 500 cel/ml) los niveles de CV, en algunos casos, son bastante altos. Como dijimos en el análisis descriptivo, ambas variables están muy debilmente relacionadas.
