...
Se plantean un conjunto de preguntas a aplicar sobre el dataset con el objetivo de obtener conclusiones relevantes de éste. Las preguntas planteadas por cada componente del grupo son (remarcadas la elegidas a desarrollar): 
#### José Angel
...
datosCSV <- read.csv("~/tmp/uoc_SAD/DatosEntrada/Tabla_Master_Nacionalidad\ y\ CD4\ cambiados", 
...
Tabla <- read.csv("~/tmp/uoc_SAD/DatosEntrada/Tabla_Master_Nacionalidad\ y\ CD4\ cambiados", 
                  header=T, dec=".", na.strings="NA",sep="")
