...
Tabla <- read.csv("~/tmp/uoc_SAD/DatosEntrada/TABLA\ MASTER.csv", 
...
#pruebas temporales
#CD4lista <- as.character(Tabla[[,"CD4"]])
#numSummary(CD4lista, groups=Tabla$SEXO, 
#           statistics=c("mean", "sd", "IQR", "quantiles"), quantiles=c(0,.25,.5,.75,1))
```
...
```{r}
DATOSCSV <- read.csv("~/tmp/uoc_SAD/DatosEntrada/TABLA\ MASTER.csv", 
                     header=T, dec=".", na.strings="NA",sep="\t")
