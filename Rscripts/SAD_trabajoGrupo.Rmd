...
####*SUBTIPO:* 
Los subtipos de del virus VIH son són consecuencia de la alta capacidad reproductiva que tienen los virus. La mayoría de esos subtipos se deben a la introducción de errores por parte de la transcriptasa inversa, generando así una amplia gama de variantes proteínas que conforman el complejo vírico. 
...
```{r}
with(DATOSCSV, plotMeans(edad, MUTACIONESPAÑA.DE.RESPAÑAISTENCIA, error.bars="se"))
```
