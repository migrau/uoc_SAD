...
##5 ¿Hay alguna relación entre el subtipo y el CD4/CV?

Primero comparamos los niveles de carga viral en distintos subtipos:

```{r}
bwplot(factor(SUBTIPO) ~ CV, data = Tabla, xlab="copias/ml", 
...
```{r}
bwplot(factor(SUBTIPO) ~ CD4, data = Tabla, xlab="cel/ml", 
...
##6. ¿Relación entre la carga viral y los CD4?
