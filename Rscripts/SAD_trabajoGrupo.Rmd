...
Sabiendo que los datos no siguen una distribución normal aplicaré el test Kruskal Wallis:

```{r}
kruskal.test(CD4 ~ SEXO, data=Tabla)
kruskal.test(CV ~ SEXO, data=Tabla)
