...
```
En este caso se aceptamos la Ho debido a que el p-valor es mayor de 0.05. Esto indica que las variables son independientes de modo que no importa que Los hombres son mas propensos a desarrollar mutaciones como que no desarrollarlas..
